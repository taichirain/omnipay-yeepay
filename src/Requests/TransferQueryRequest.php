...
use Omnipay\Yeepay\Responses\TransferQueryResponse;
 ...
 */
class TransferQueryRequest extends BaseAbstractRequest
{
    protected $method = '';
    protected $endpoint = 'https://o2o.yeepay.com/zgt-api/api/transferQuery';
    ...
    {
        return $this->getParameter('ledgerno');
    }

    public function setLedgerno($ledgerno) 
    {
        $this->setParameter('ledgerno', $ledgerno);
    }
    ...
    {
        return $this->response = new TransferResponse($this, $data, $statusCode);
    }
